...
class TestEStorage(TestCase):
    ...
    def test_seller(self):
        ...
        plan_fact_event_1 = PlanFactEvent.objects.create(storage_guid=storage_guid_1, product_guid=product_guid_mi8, quantity=quantity_mi8, price_currency=currency_mi8, price_purchase=purchase_cost_mi8, is_in=True, is_out=False, is_plan=False, is_fact=True)
        ...
        plan_fact_event_2 = PlanFactEvent.objects.create(storage_guid=storage_guid_2, product_guid=product_guid_mi8, quantity=quantity_mi8_2_1, price_currency=currency_mi8_2_1, price_purchase=purchase_cost_mi8_2_1, is_in=True, is_out=False, is_plan=False, is_fact=True)
        ...
        purchase_cost_r = 80
        currency_r = "USD"
        plan_fact_event_3 = PlanFactEvent.objects.create(storage_guid=storage_guid_1, product_guid=product_guid_r, quantity=quantity_r, price_currency=currency_r, price_purchase=purchase_cost_r, is_in=True, is_out=False, is_plan=False, is_fact=True)
        ...
        currency_mi8_2 = "USD"
        plan_fact_event_4 = PlanFactEvent.objects.create(storage_guid=storage_guid_1, product_guid=product_guid_mi8, quantity=quantity_mi8_2, price_currency=currency_mi8_2, price_purchase=purchase_cost_mi8_2, is_in=True, is_out=False, is_plan=False, is_fact=True)
        quantity = PlanFactEvent.count_product([storage_guid_1], [product_guid_mi8])
        ...
        quantity_mi8_3 = 4
        plan_fact_event_5 = PlanFactEvent.objects.create(storage_guid=storage_guid_1, product_guid=product_guid_mi8, quantity=quantity_mi8_3, price_currency=currency_mi8_2, price_purchase=purchase_cost_mi8_2, is_in=False, is_out=True, is_plan=False, is_fact=True)
        quantity = PlanFactEvent.count_product([storage_guid_1], [product_guid_mi8])
